...
<head>
    ...
    <title>{{ __('messages.login') }} - {{ __('messages.wasila') }}</title>
...
<body class="flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <!-- Login Form -->
        <div class="login-container rounded-3xl p-8">
            ...
            <form method="POST" action="{{ route('customer.login') }}">
                ...
                <button type="submit" class="btn-login text-white w-full py-3 rounded-xl font-semibold mb-4">
                    <i class="fas fa-sign-in-alt mr-2"></i>
                    {{ __('messages.login') }}
                </button>
            </form>
            ...
            <div class="text-center mt-6">
                <p class="text-white/80">
                    ...
                    <a href="{{ route('customer.register') }}" class="text-white font-semibold hover:text-gold transition">
