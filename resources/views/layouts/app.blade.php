                ...
                <div>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div>
                                <p class="text-gray-300 font-medium">{{ app()->getLocale() === 'ar' ? 'البريد الإلكتروني' : 'Email' }}</p>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <p class="text-gray-300 font-medium">{{ app()->getLocale() === 'ar' ? 'الهاتف' : 'Phone' }}</p>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <p class="text-gray-300 font-medium">{{ app()->getLocale() === 'ar' ? 'العنوان' : 'Address' }}</p>
            ...
            <div class="border-t border-white/20 pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div class="flex space-x-6 {{ app()->getLocale() === 'ar' ? 'space-x-reverse' : '' }}">
                        <a href="#" class="text-gray-300 hover:text-accent transition duration-300 text-sm">
