...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow-lg card-shadow p-6">
        <h2 class="text-2xl font-bold text-primary-dark mb-6">تعديل الخدمة</h2>
        ...
        <form method="POST" action="{{ route('admin.services.update', $service) }}" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="name_ar" name="name_ar" value="{{ old('name_ar', $service->name_ar) }}" required
                ...
                <div>
                    ...
                    <input type="text" id="name_en" name="name_en" value="{{ old('name_en', $service->name_en) }}" required
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description_ar" name="description_ar" rows="3" required
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-medium focus:border-transparent @error('description_ar') border-red-500 @enderror">{{ old('description_ar', $service->description_ar) }}</textarea>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description_en" name="description_en" rows="3" required
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-medium focus:border-transparent @error('description_en') border-red-500 @enderror">{{ old('description_en', $service->description_en) }}</textarea>
                ...
                <div>
                    ...
                    <input type="number" id="sort_order" name="sort_order" min="0" value="{{ old('sort_order', $service->sort_order) }}"
                ...
                <div>
                    ...
                    <input type="text" id="category_ar" name="category_ar" value="{{ old('category_ar', $service->category_ar) }}" required
                ...
                <div>
                    ...
                    <input type="text" id="category_en" name="category_en" value="{{ old('category_en', $service->category_en) }}" required
                ...
                <!-- New Image -->
                <div class="md:col-span-2">
                    <label for="image" class="block text-sm font-medium text-gray-700 mb-2">صورة جديدة (اختياري)</label>
