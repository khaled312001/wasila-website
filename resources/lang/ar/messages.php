...
return [
    ...
    // SEO
    'site_title' => 'وسيلة - منصة الخير والتبرعات',
    'site_description' => 'منصة وسيلة الخيرية للتبرعات والخدمات الإنسانية. نساعد في ربط المحتاجين بالمتبرعين لبناء مجتمع أفضل في المملكة العربية السعودية.',
    'site_keywords' => 'وسيلة, خير, تبرعات, خدمات إنسانية, منصة خيرية, السعودية, الرياض, مساعدات, إغاثة, تطوع',
