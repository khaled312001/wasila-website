...
<IfModule mod_headers.c>
    ...
    private function seedServices()
    {
        $services = [
            [
                ...
                'price' => 50.00,
                'image' => 'services/35LBAIj7gi8HLOWiIbGjiCs82UFloL9YDKhOePuS.png',
            ...
            [
                ...
                'price' => 75.00,
                'image' => 'services/94ahRvARwxYgD3RzedyPEOIgk6BSESNYk98XQRgH.png',
                'category_ar' => 'خدمات المساجد',
                'category_en' => 'Mosque Services',
                'is_active' => 1,
                'sort_order' => 2,
            ...
            [
                ...
                'price' => 25.00,
                'image' => 'services/dFmRXwOqLlA8muu3Fp8iKyPld0PHe0b89AKGr2ty.png',
            ...
            [
                ...
                'price' => 200.00,
                'image' => 'services/eQB6TG9VQ34coM08oTZgtwIUCV3kXDQALT5F5E07.png',
    ...
    private function seedSettings()
    {
        $settings = [
            ...
            ['key' => 'site_description', 'value' => 'منصة وسيلة والخدمات', 'type' => 'text', 'description' => 'وصف الموقع'],
            ['key' => 'contact_email', 'value' => 'info@wasila.com', 'type' => 'string', 'description' => 'البريد الإلكتروني للتواصل'],
            ['key' => 'contact_phone', 'value' => '+966 55 922 9980', 'type' => 'string', 'description' => 'رقم الهاتف للتواصل'],
            ['key' => 'address', 'value' => 'مكة المكرمة ، المملكة العربية السعودية', 'type' => 'text', 'description' => 'العنوان'],
            ['key' => 'address_ar', 'value' => 'مكة المكرمة ، المملكة العربية السعودية', 'type' => 'text', 'description' => 'العنوان بالعربية'],
            ...
            ['key' => 'hero_title_ar', 'value' => 'وسيلة - مشروع اجتماعي', 'type' => 'string', 'description' => 'عنوان الصفحة الرئيسية بالعربية'],
            ['key' => 'hero_title_en', 'value' => 'Wasila - Social Project', 'type' => 'string', 'description' => 'عنوان الصفحة الرئيسية بالإنجليزية'],
            ...
            ['key' => 'about_description_ar', 'value' => 'وسيلة هو مشروع اجتماعي يهدف إلى تقديم خدمات إنسانية متنوعة للمجتمع. نحن نؤمن بأهمية التكافل الاجتماعي في بناء مجتمع أفضل.', 'type' => 'text', 'description' => 'وصف من نحن بالعربية'],
            ['key' => 'about_description_en', 'value' => 'Wasila is a social project that aims to provide various humanitarian services to the community. We believe in the importance of social solidarity in building a better society.', 'type' => 'text', 'description' => 'وصف من نحن بالإنجليزية'],
            ...
            ['key' => 'feature1_description_ar', 'value' => 'نقدم مجموعة واسعة من الخدمات الاجتماعية مع ضمان الجودة العالية والكفاءة في التنفيذ', 'type' => 'text', 'description' => 'وصف الميزة الأولى بالعربية'],
            ['key' => 'feature1_description_en', 'value' => 'We provide a wide range of social services with guaranteed high quality and efficiency in implementation', 'type' => 'text', 'description' => 'وصف الميزة الأولى بالإنجليزية'],
            ...
            ['key' => 'feature2_description_en', 'value' => 'We ensure complete transparency in all our operations and provide periodic reports on services provided', 'type' => 'text', 'description' => 'وصف الميزة الثانية بالإنجليزية'],
            ...
            ['key' => 'cta_title_ar', 'value' => 'ابدأ رحلتك معنا', 'type' => 'string', 'description' => 'عنوان دعوة العمل بالعربية'],
            ['key' => 'cta_title_en', 'value' => 'Start Your Journey With Us', 'type' => 'string', 'description' => 'عنوان دعوة العمل بالإنجليزية'],
            ['key' => 'cta_description_ar', 'value' => 'انضم إلينا في رحلة خدمة المجتمع وتحقيق التغيير الإيجابي', 'type' => 'text', 'description' => 'وصف دعوة العمل بالعربية'],
            ['key' => 'cta_description_en', 'value' => 'Join us on the journey of serving the community and achieving positive change in society', 'type' => 'text', 'description' => 'وصف دعوة العمل بالإنجليزية'],
            ['key' => 'footer_description_ar', 'value' => 'وسيلة - مشروع اجتماعي يهدف لخدمة المجتمع وتقديم المساعدة للمحتاجين', 'type' => 'text', 'description' => 'وصف التذييل بالعربية'],
            ['key' => 'footer_description_en', 'value' => 'Wasila - A social project aimed at serving the community and providing assistance to those in need', 'type' => 'text', 'description' => 'وصف التذييل بالإنجليزية']
        ];
    ...
    private function seedContactMessages()
    {
        $messages = [
            ...
            [
                ...
                'message' => 'أود الاستفسار عن مشاريعكم، كيف يمكنني المساهمة؟',
                'is_read' => 0,
