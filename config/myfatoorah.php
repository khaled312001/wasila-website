...
return [
     ...
     */
    'test_mode' => function() {
        return \App\Helpers\SettingsHelper::get('myfatoorah_is_test', env('MYFATOORAH_TEST_MODE', '1')) == '1';
    },
    /**
    ...
    'country_iso' => function() {
        return \App\Helpers\SettingsHelper::get('myfatoorah_country_iso', env('MYFATOORAH_COUNTRY_ISO', 'SA'));
    },
    /**
     * Save card (boolean)
